    ...
    if(!empty($username) && !empty($password)){
        ...
        $stmt->store_result();
            ...
            if($stmt-> num_rows > 0){
                ...
                header("location: student_dashboard.php"); //navigate file
                exit();
            } else {
                //if user not found
...
<head>
    ...
    <title>Student Login - EduSpark</title>
    ...
    <div class="login-container">
        ...
        <div class="login-background">
            ...
            <div class="login-illustration">
                <img src="https://www.oxfordlearning.com/wp-content/uploads/2018/07/how-to-prepare-for-high-school-min.jpeg" alt="Student Learning">
            </div>
        </div>
    </div>
